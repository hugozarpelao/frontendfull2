    ...
    return (
        <div>
            <Table striped bordered hover>
                ...
                <tbody>
                    {
                        props.listaItens?.carro.map((item, indice) => {
                            totalVendas += parseFloat(item.subtotal);
                            props.valorReserva(totalVendas);
                            return <tr key={indice}>
                                ...
                                <td>
                                    <Button onClick={() => {
                                        const lista = props.listaItens.carro.filter((car) => car.codigo !== item.codigo);
                                        props.setReserva({ ...props.dadosReserva, carro: lista });
                                        props.valorReserva(totalVendas);
                                    }}>
